...
int mdadm_read(uint32_t addr, uint32_t len, uint8_t *buf) {
    ...
    while (bytes_read < len) {
        ...
        // Read the block data
        if (jbod_operation(id_checker(0, 0, JBOD_READ_BLOCK, 0), temp_buf) == -1) {
            return -1; // Read error
        }
...
int mdadm_write(uint32_t addr, uint32_t len, const uint8_t *buf) {
    ...
    while (bytes_written < len) {
        ...
        if(cache_lookup(curr_disk, curr_block, temp_buf) == -1){ //Checks if the current block is not in cache
        	if (jbod_operation(id_checker(0, 0, JBOD_READ_BLOCK, 0), temp_buf) == -1) { // Read the block data
           		return -1; // Read error
        	}
        }
        ...
        if (jbod_operation(id_checker(0, 0, JBOD_WRITE_BLOCK, 0), temp_buf) == -1) {
...
/*CWD /home/anishoberoi/sp24-lab4-AnishOberoi */
/*CWD /home/anishoberoi/sp24-lab4-AnishOberoi */
/*CWD /home/anishoberoi/sp24-lab4-AnishOberoi */
/*CWD /home/anishoberoi/sp24-lab4-AnishOberoi */
/*CWD /home/anishoberoi/sp24-lab4-AnishOberoi */
